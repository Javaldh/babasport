...
import ldh.core.bean.product.Img;
import ldh.core.bean.product.Product;
import ldh.core.bean.product.Sku;
import ldh.core.dao.product.ProductDao;
import ldh.core.query.ImgQuery;
