				...
				<tbody>
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required" name="name" maxlength="100"
							value="${brand.name }" /></td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h"><span
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><img width="100"
							height="100" id="allImgUrl" src="${brand.allUrl }"/> <input type="hidden" name="imgUrl"
							id="path" value="${brand.imgUrl }"/> <input type="file" onchange="uploadPic()" name="pic" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required" name="sort" value="${brand.sort }"
							maxlength=" 80" /></td>
					</tr>
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="radio"
							...
							<c:if
								test="${brand.isDisplay } ==1">checked="checked"</c:if> />可用
							<input type="radio" name="isDisplay" value="0"
							<c:if
								test="${brand.isDisplay } ==0">checked="checked"</c:if> />不可用</td>
					</tr>
				</tbody>
				<tbody>
					<tr>
