	...
	<div class="body-box">
		<form action="/product/list.do" method="post"
			...
			<input type="hidden" value="1" name="pageNo" /> 名称: <input
				type="text" onkeyup="changePageNo()" value="" name="name" /> <select
				name="brandid">
			...
			</select> <select onchange="changePageNo()" name="isShow">
					...
					<c:forEach items="${pagination.list }" var="entry">
						...
						<tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'"
							...
							<td align="center"><img width="50" height="50"
								src="${entry.img.allUrl }" /></td>
							<td align="center">是</td>
							<td align="center">是</td>
							<td align="center">是</td>
							<td align="center"><c:if test="${isShow == 0}"></c:if>下架<c:if
									test="${isShow == 1}"></c:if>上架</td>
							<td align="center"><a href="#" class="pn-opt">查看</a> | <a
								...
								| <a href="../sku/list.jsp" class="pn-opt">库存</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
